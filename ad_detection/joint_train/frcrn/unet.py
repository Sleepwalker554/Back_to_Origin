...
class Encoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 padding=None, complex=False, padding_mode='zeros'):
        super().__init__()
        if padding is None:
...
class UNet(nn.Module):
    ...
    def __init__(self, input_channels=1, complex=False,
                 model_complexity=45, model_depth=20, padding_mode='zeros'):
        super().__init__()
        ...
        for i in range(self.model_length):
            ...
            module = Encoder(
                self.enc_channels[i], self.enc_channels[i + 1],
        ...
        for i in range(self.model_length):
            ...
            module = Decoder(
                self.dec_channels[i] * 2, self.dec_channels[i + 1],
    ...
    def set_size(self, model_complexity, model_depth=20, input_channels=1):
        ...
        if model_depth == 14:
            ...
            self.enc_channels = [input_channels, 16, 32, 64, 128, 256]
            ...
            self.enc_strides = [(1, 1), (1, 1), (2, 2), (2, 1), (2, 2), (2, 1),
                                (2, 2), (2, 1), (2, 2), (2, 1)]
            self.enc_paddings = [
                (3, 0), (0, 3), None, None, None, None, None, None, None, None
            ]
            self.dec_channels = [
